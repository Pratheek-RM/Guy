...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../final2_soc.sopcinfo
...
# Design Name 
# setting SOPC_NAME is final2_soc
SOPC_NAME := final2_soc
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1512003615
SOPC_SYSID_FLAG += --timestamp=1512003615
ELF_PATCH_FLAG  += --timestamp 1512003615
